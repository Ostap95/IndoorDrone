...
sensor_right = DistanceSensor(echo=26, trigger=19, max_distance=2)
sensor_left = DistanceSensor(echo=13, trigger=6, max_distance=2)
sensor_back = DistanceSensor(echo=21, trigger=20, max_distance=2)
